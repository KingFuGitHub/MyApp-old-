    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navViewRightGames.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.miSkill_3 -> {
                    if (GOLD >= 3500 && obtainSkill_3 == false) {
                        cvSkill_3_Border.toggleVisibility()
                        tvCoins.text = "${GOLD - 3500}"
                        GOLD = GOLD - 3500
                        YoYo.with(Techniques.Shake).playOn(tvCoins)
                        obtainSkill_3 = true
                        toast3.show()
                    } else if (GOLD < 3500 && obtainSkill_3 == false) {
                        insufficientGold.show()
                    } else {
                        toast1.show()
                    }
                ...
                R.id.miSkill_4 -> {
                    if (GOLD >= 4500 && obtainSkill_4 == false) {
                        cvSkill_4_Border.toggleVisibility()
                        tvCoins.text = "${GOLD - 4500}"
                        GOLD = GOLD - 4500
                        YoYo.with(Techniques.Shake).playOn(tvCoins)
                        obtainSkill_4 = true
                        toast3.show()
                    } else if (GOLD < 4500 && obtainSkill_4 == false) {
                        insufficientGold.show()
                    } else {
                        toast1.show()
                    }
    ...
    private fun killCheck() {
        if (pbhealthBar.progress == 0) {
            ...
            if (currentStage % 10 == 0) {
                var randomArmor = kotlin.random.Random.nextInt(2, 7)
